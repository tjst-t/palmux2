...
現在: **v0.12.0 リリース済み (Sb14caa = palmuxOS アプライアンス化マイルストーン)**。以降 main に **Sd44947 (Phase 6 マイルストーン: 共有フォルダの宣言化 profile-as-mold) を merge 済み** (次リリース候補)。Phase 0〜4 のコア + 磨き込みに加え、以降のスプリントで以下を実装済み:
