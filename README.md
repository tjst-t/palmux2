...
/{repoId}/{branchId}/git                                # git tab (single 2-column view: changes + history + diff)
...
# → release at https://github.com/tjst-t/palmux2/releases/tag/v0.3.0
```
...
/{repoId}/{branchId}/git                                # Git タブ (Changes + History + Diff の 2 カラム単一画面)
...
git tag v0.3.0
git push origin v0.3.0
# → https://github.com/tjst-t/palmux2/releases/tag/v0.3.0 にリリースが作成される
```
