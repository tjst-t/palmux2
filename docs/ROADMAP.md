...
- **現在のスプリント: S003 — Sub-agent (Task) 入れ子ツリー** (autopilot 実装完了 / 実機 smoke のみ milestone レビュー待ち)
- 合計: 6 スプリント | 完了: 0 | 進行中: 3 | 残り: 3
- [░░░░░░░░░░░░░░░░░░░░] 0% (S001 / S002 / S003 の milestone マージ待ち)
...
## スプリント S002: `.claude/settings.json` editor [IN PROGRESS]
...
## スプリント S003: Sub-agent (Task) 入れ子ツリー [IN PROGRESS]
