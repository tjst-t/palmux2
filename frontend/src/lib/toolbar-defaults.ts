    ...
    rows: [
      [
        ...
        { type: 'modifier', modifier: 'shift', label: 'Shift' },
        {
          type: 'popup',
          label: '⤓',
          primary: { type: 'key', key: 'Enter', label: '↵' },
          alternates: [
            { type: 'key', key: 'Backspace', label: '⌫' },
            { type: 'key', key: 'Delete', label: 'Del' },
            { type: 'key', key: 'Home', label: 'Home' },
            { type: 'key', key: 'End', label: 'End' },
            { type: 'key', key: 'PageUp', label: 'PgUp' },
            { type: 'key', key: 'PageDown', label: 'PgDn' },
          ],
        },
